...
##################################################
    ...
    inodesi[0].append(node.pop())
    inodesj[0].append(node.pop())
    istrain_bonds[0].append(-1)
...
for (NN, irec, NTS, eta, Lp) in jobs:
    ...
    directory = "/data1/home/rocks/data/sat_transition/tune_disc_2D_nodepair_default/"
