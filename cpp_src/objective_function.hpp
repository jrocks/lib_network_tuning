...
class InfNormObjFunc {
    ...
    public:
        ...
        InfNormObjFunc(int NT, RXVec target) {
            this->NT = NT;
            this->target = target;
...
XVec InfNormObjFunc::evalRes(RXVec& m) {
...
double InfNormObjFunc::evalFunc(RXVec& m) {
...
class SumObjFunc {
    ...
    public:
        ...
        SumObjFunc(int NT, RXVec target) {
            this->NT = NT;
            this->target = target;
...
XVec SumObjFunc::evalRes(RXVec& m) {
...
double SumObjFunc::evalFunc(RXVec& m) {
